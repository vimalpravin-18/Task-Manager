    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] p-4">
      <div className="w-full max-w-md animate-fadeSlideUp">
        <div className="p-8 bg-[var(--bg-card)] rounded-xl border-2 border-[var(--border-default)] shadow-[var(--shadow-card)]">
          ...
          <p className="text-sm text-[var(--text-secondary)] mb-6 text-center">Sign in to your account</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="flex justify-start items-center">
              <label className="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-3 h-3 md:w-4 md:h-4 accent-[var(--accent)] cursor-pointer" />
                Remember me
              </label>
            </div>
          ...
          <p className="text-center text-[var(--text-secondary)]">
            Don't have an account? <Link to="/register" className="text-[var(--accent)] font-medium hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
